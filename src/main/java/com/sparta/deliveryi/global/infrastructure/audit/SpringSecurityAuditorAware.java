 ...
 *
 * <p>
 * 현재 인증된 사용자의 아이디(username)를 생성 및 수정자(auditor) 정보로 제공합니다.
...
public class SpringSecurityAuditorAware implements AuditorAware<String> {
     ...
     * 현재 사용자의 이름을 가져와 감사자(auditor)로 반환합니다.
     *
     * @return 인증된 사용자의 이름을 담은 Optional, 인증 정보가 없거나 인증되지 않은 경우 빈 Optional
     */
    @NonNull
    @Override
