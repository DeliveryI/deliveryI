...
class MenuServiceTest {
    ...
    void createMenu_withAi_success() {
        ...
        MenuResult result = menuService.createMenu(storeId, command);
    ...
    void updateMenu_withAi_success() {
        ...
        MenuResult result = menuService.updateMenu(1L, command);
    ...
    void changeMenuStatus_success() throws Exception {
        Menu m1 = Menu.create(UUID.randomUUID(), "라면", 5000, "간편식", MenuStatus.FORSALE, "tester");
        Menu m2 = Menu.create(UUID.randomUUID(), "냉면", 9000, "여름별미", MenuStatus.HIDING, "tester");
        ...
        List<Long> changed = menuService.changeMenuStatus(cmds, "admin");
